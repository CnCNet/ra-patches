...
@HACK 0x004EB0D7, _InfantryTypeClass__One_Time_Invisible_Infantry_Fix
	cmp dword eax, 0
...
@HACK 0x004EB12E, _InfantryTypeClass__One_Time_Invisible_Icon_Fix
	cmp dword eax, 0
...
@HACK 0x00453689, _BuildingTypeClass__One_Time_Missile_Silo_Buildup_Fix
	cmp dword eax, 0
...
@HACK 0x00453703, _BuildingTypeClass__One_Time_Civilian_Buildings_Fix
	cmp dword eax, 0
...
@HACK 0x0053755D, _RulesClass__Objects_Epilogue
