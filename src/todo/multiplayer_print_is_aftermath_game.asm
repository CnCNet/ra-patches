...
@HACK 0x00513D46 _Skirmish_Dialog_Aftermath_Text
...
@HACK	0x0050C2B0 _LAN_New_Dialog_Aftermath_Text
	call Fancy_Text_Print
	add esp, 18h
...
@HACK	0x0050C748 _LAN_New_Dialog_Aftermath_Text2
	call Is_Aftermath_Installed
	cmp eax, 1
	jnz .Ret
...
@HACK	0x0050DB55 _LAN_New_Dialog_Aftermath_Text3
	mov eax, [ebp-08Ch]
	mov byte [startedasam], 1
	jmp 0x0050DB5B
@ENDHACK