...
@HACK 0x0052DB02, _RadarClass__Draw_It_Radarframes_Special_Houses
...
@HACK 0x0052DA5C, _RadarClass__Draw_It_Radarshape_Special_Houses
    mov eax, [eax+3Eh]  ; hooked by patch
    sar eax, 18h
...
@HACK 0x0054E0A4, _SidebarClass__Reload_Logoshape_Special_Houses
...
@HACK 0x0054D359, _SidebarClass__Reload_Sidebar_Special_Houses
